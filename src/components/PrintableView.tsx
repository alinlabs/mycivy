...
const defaultItemSelection: ItemSelectionState = {
  ...
  skills: {
    hardGroup: true,
    hard: { 0: true, 1: true, 2: true, 3: true, 4: true, 5: true, 6: true, 7: true },
    softGroup: true,
    soft: { 0: true, 1: true, 2: true, 3: true, 4: true, 5: true, 6: true, 7: true },
    toolsGroup: true,
    tools: { 0: true, 1: true, 2: true, 3: true, 4: true, 5: true, 6: true },
  },
  certifications: {
    'cert-1': true,
  },
