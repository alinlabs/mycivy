...
export const business_operationsProjects: TailoredProjectSet = {
    ...
    digitalSolutions: [
      ...
      {
        id: 'sol-8',
        title: 'ALINLABS MY KARIR',
        subtitle: 'Workforce Administration & Internal HRIS Platform',
        category: 'management',
        demoUrl: 'https://hrworkforce.vercel.app',
        isPrototype: true,
        description:
          'Platform operasional SDM internal berbasis web untuk manajemen tenaga kerja: presensi digital GPS Geo-fencing & QR Code multi-cabang, monitoring penugasan harian tim berbasis task milestone, database profil karyawan, dan evaluasi KPI operasional tim kerja.',
        impact:
          'Memastikan tingkat kepatuhan presensi operasional 90%+, mempercepat monitoring penugasan kerja tim 2x lipat, dan merapikan administrasi kepegawaian internal secara terpusat.',
        techStack: ['GPS Geo-Fencing', 'Task Milestone Tracker', 'Shift Scheduling', 'Internal HRIS'],
        features: ['Multi-Branch QR/GPS Attendance', 'Daily Task Log & Dispatch', 'Operational KPI Matrix', 'Employee Profile Registry'],
      },
      {
        id: 'sol-4',
        title: 'NEXTMARK',
