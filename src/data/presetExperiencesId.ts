  ...
  "manufacturing_operations": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Memimpin alur workshop produksi interior, fabrikasi perakitan, alokasi material, pengiriman logistik, hingga instalasi proyek.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Mengelola kemitraan pasokan mesin pencetakan digital produksi & perkantoran Konica Minolta ke pabrik manufaktur di kawasan industri.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Mengawasi operasional inventaris produk, kelancaran distribusi pasokan, dan tata kelola teknis gerai untuk 5 toko ritel.",
      "highlights": [
        "Mengatur sistem pengendalian stok dan alur pengisian ulang (replenishment) barang secara teratur di 5 gerai ritel.",
        "Mengordinasikan jadwal operasional dan SOP pelayanan staf frontliner toko guna menjaga efisiensi dan kualitas layanan.",
        "Melakukan inspeksi berkala kondisi toko, penataan display, serta evaluasi perputaran inventaris (stock turnover)."
      ],
      "metrics": [
        {
          "label": "Gerai Ritel",
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengelola alur distribusi stok barang, promosi multi-cabang, dan koordinasi logistik ritel 8 gerai.",
      "highlights": [
  ...
  "hospital_office_admin": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Memimpin tata kelola administrasi perkantoran, dokumentasi kontrak, standarisasi dokumen pelaporan, serta koordinasi operasional 6 divisi kerja.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Mengelola administrasi kontrak korporat B2B, penawaran harga resmi, serta arsip data 4.000+ perusahaan.",
      "highlights": [
      ...
      "metrics": [
        {
          "label": "Arsip Database",
          "value": "4.000+"
        },
        {
          "label": "Klien Terkelola",
          "value": "100+"
        }
      ],
      "tools": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengelola administrasi operasional toko, dokumen transaksi harian, kearsipan, dan rekapitulasi penjualan 5 gerai ritel.",
      "highlights": [
        "Mengonsolidasikan laporan administrasi harian, berkas transaksi kasir, dan penataan kearsipan dari 5 gerai ritel.",
        "Mengelola inventaris perangkat operasional toko, kearsipan surat penawaran, dan dokumentasi izin usaha cabang.",
        "Mengoordinasikan administrasi personalia staf toko, jadwal piket, serta pencatatan absensi harian."
      ],
      "metrics": [
        {
          "label": "Administrasi Cabang",
          "value": "5 Gerai"
        },
        {
          "label": "Akurasi Laporan",
          "value": "99%"
        }
      ],
      "tools": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengelola pencatatan administrasi gerai, rekonsiliasi data kas, dan korespondensi promosi ritel.",
      "highlights": [
  ...
  "optimal": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Memimpin operasional end-to-end perusahaan interior design & build (desain, manufaktur, logistik, instalasi, dan project management) untuk 100+ proyek komersial dan residensial.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Mengelola penjualan B2B dan ekspansi akun korporat sebagai distributor resmi tunggal mesin fotokopi digital multifungsi & sistem pencetakan produksi Konica Minolta (MFP, Production Printing, Large Format).",
      "highlights": [
      ...
      "metrics": [
        {
          "label": "Klien B2B Aktif",
          "value": "100+"
        },
        {
          "label": "Database Korporat",
          "value": "4.000+"
        },
        {
          "label": "Prospek Baru/Bln",
          "value": "5-7 Klien"
        },
        {
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengelola strategi komunikasi pemasaran, kampanye promosi terpadu, serta aktivitas branding multi-cabang untuk jaringan 5 gerai ritel gadget & smartphone.",
      "highlights": [
        "Merancang dan mengeksekusi kampanye pemasaran ritel bulanan, aktivasi promosi toko, dan penataan visual POS di 5 gerai ritel.",
        "Mengelola penganggaran dan optimasi iklan digital multi-channel (Meta Ads & TikTok Ads) untuk meningkatkan kunjungan pelanggan.",
        "Melakukan inspeksi dan supervisi berkala ke seluruh gerai cabang untuk memastikan kepatuhan visual merchandising dan display produk.",
        "Menganalisis data performa penjualan cabang, Return on Ad Spend (ROAS), serta tren produk harian."
      ],
      "metrics": [
        {
          "label": "Gerai Ritel",
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengawasi komunikasi pemasaran, promosi terpadu, dan branding gerai ritel untuk jaringan 8 cabang toko gadget & solusi IoT.",
      "highlights": [
  ...
  "business_operations": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Mengendalikan seluruh rantai operasional harian perusahaan interior design & build (desain arsitektur, produksi workshop, pengiriman logistik, hingga instalasi lapangan) untuk 100+ proyek komersial & residensial.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Mengelola operasional pelayanan akun B2B, logistik distribusi unit, dan manajemen alur kerja pasca-penjualan mesin digital multifungsi Konica Minolta untuk 100+ korporat.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Memimpin operasional harian 5 gerai toko ritel, efisiensi alur pelayanan, serta sinkronisasi aktivitas promosi toko.",
      "highlights": [
        "Mengarahkan standar operasional toko dan efektivitas alur transaksi kasir di 5 gerai ritel gadget.",
        "Melakukan supervisi rutin ke seluruh cabang untuk memastikan keselarasan display, ketersediaan stok, dan kualitas pelayanan.",
        "Mengevaluasi laporan kinerja harian toko serta mengimplementasikan perbaikan proses operasional cabang."
      ],
      "metrics": [
        {
          "label": "Supervisi Cabang",
          "value": "5 Gerai"
        },
        {
          "label": "Standar Toko",
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengendalikan operasional ritel, audit display toko, standardisasi SOP promosi, dan koordinasi staf kasir/frontliner di 8 gerai cabang toko gadget dan smart devices.",
      "highlights": [
  ...
  "project_management": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Memimpin tata kelola proyek komprehensif, manajemen milestone, alokasi sumber daya, dan penjaminan SLA untuk 100+ proyek interior komersial dan residensial.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Mengelola siklus proyek pengadaan, implementasi solusi mesin cetak korporat, dan manajemen kontrak B2B untuk 100+ akun industri manufaktur.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengelola proyek kampanye promosi toko, aktivasi produk baru, dan pengerjaan materi promosi di 5 gerai ritel.",
      "highlights": [
        "Menyusun lini masa dan alokasi sumber daya untuk proyek kampanye promosi bulanan di 5 cabang toko.",
        "Mengoordinasikan peluncuran produk baru dan pemasangan materi promosi visual (POSM) tepat waktu.",
        "Mengevaluasi ketercapaian tenggat waktu dan indikator keberhasilan proyek aktivasi toko."
      ],
      "metrics": [
        {
          "label": "Proyek Kampanye",
          "value": "12 Proyek"
        },
        {
          "label": "Cakupan Toko",
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengelola siklus proyek kampanye pemasaran terpadu, produksi konten multimedia, dan aktivasi gerai secara serentak di 8 cabang toko ritel.",
      "highlights": [
  ...
  "business_development": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Menyelaraskan kapabilitas operasional produksi dengan kebutuhan proyek komersial klien korporat, menjaga retensi klien, dan kepuasan kemitraan bisnis.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Mendorong ekspansi pasar B2B, penetrasi sektor industri korporat, negosiasi kontrak strategis, dan retensi akun mesin digital Konica Minolta.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Mengembangkan kerja sama komersial dengan distributor supplier dan strategi penawaran paket bundling ritel di 5 gerai.",
      "highlights": [
        "Membangun kemitraan promosi bundling dengan distributor resmi smartphone dan aksesori gadget.",
        "Menganalisis potensi pasar lokal dan merancang program komersial untuk meningkatkan nilai transaksi rata-rata.",
        "Mengakuisisi peluang penjualan paket produk untuk kebutuhan kelompok/korporat lokal."
      ],
      "metrics": [
        {
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengembangkan kemitraan strategis dengan brand principal, perluasan channel pemasaran, dan negosiasi sponsorship promosi di 8 gerai ritel.",
      "highlights": [
  ...
  "digital_transformation": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Memimpin transformasi digital alur operasional, digitalisasi dokumentasi proyek, dan otomatisasi pelaporan lintas 6 divisi manufaktur-konstruksi.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Mengembangkan sistem CRM terintegrasi, digitalisasi database korporat, dan otomatisasi rute kanvasing penjualan B2B mesin cetak digital.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengintegrasikan sistem promosi digital Meta/TikTok Ads dengan data penjualan POS di 5 gerai toko ritel.",
      "highlights": [
        "Mengoptimalkan iklan digital (Meta Ads & TikTok Ads) untuk mendorong kunjungan fisik pelanggan ke 5 toko.",
        "Menyusun dasbor pelaporan digital terintegrasi untuk memantau performa penjualan harian cabang.",
        "Menerapkan otomatisasi pencatatan data prospek pelanggan dan promosi digital toko."
      ],
      "metrics": [
        {
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Memimpin digitalisasi strategi promosi, pengelolaan periklanan digital multi-channel, dan integrasi analitik penjualan POS di 8 cabang ritel.",
      "highlights": [
  ...
  "hr_operations": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Mengelola pembagian peran tim, evaluasi kinerja lintas 6 divisi fungsional, dan pembinaan SOP kerja untuk 100+ proyek interior design & build.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Membangun relasi profesional dengan pimpinan HRGA korporat, memahami kebutuhan fasilitas kantor, dan mengelola negosiasi pengadaan B2B.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Mengelola administrasi personalia, pembagian giliran kerja (shift), dan pembekalan standar pelayanan staf di 5 gerai ritel.",
      "highlights": [
        "Menyusun jadwal giliran kerja dan memantau kedisiplinan kehadiran 20+ staf toko di 5 gerai cabang.",
        "Memberikan pelatihan standar pelayanan (SOP pelayanan) dan pembekalan produk bagi staf frontliner baru.",
        "Mengelola evaluasi kinerja berkala staf gerai dan administrasi komisi/insentif penjualan."
      ],
      "metrics": [
        {
          "label": "Staf Terkelola",
          "value": "20+ Staf"
        },
        {
          "label": "Jaringan Gerai",
          "value": "5 Cabang"
        }
      ],
      "tools": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Memimpin pelatihan product knowledge staf kasir/sales, standardisasi etika pelayanan toko, dan koordinasi tim kreatif di 8 gerai ritel.",
      "highlights": [
  ...
  "strategic_management": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Merumuskan strategi eksekusi operasional bisnis, penjaminan standar mutu SLA, efisiensi biaya, dan tata kelola 6 divisi untuk 100+ proyek interior.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Mengembangkan strategi penetrasi pasar industri, manajemen akun strategis B2B, dan penguasaan teritori 4 kawasan industri mesin cetak Konica Minolta.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Merancang strategi penetrasi pasar ritel, branding lokasi, dan analisis performa bisnis untuk 5 gerai toko.",
      "highlights": [
        "Menyusun strategi promosi lokasi dan penataan citra merek di 5 gerai ritel gadget.",
        "Menganalisis tren kompetisi lokal dan perilaku konsumen untuk mempertahankan pangsa pasar toko.",
        "Mengevaluasi profitabilitas per gerai dan efektivitas alokasi biaya pemasaran."
      ],
      "metrics": [
        {
          "label": "Cakupan Gerai",
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengembangkan strategi positioning brand, portofolio kemitraan principal, dan ekspansi promosi multi-cabang di 8 gerai toko ritel gadget/IoT.",
      "highlights": [
  ...
  "marketing": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Mengelola integrasi operasional dengan strategi promosi proyek, dokumentasi portofolio komersial, dan kepuasan klien untuk 100+ proyek interior.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Memimpin kampanye pemasaran solusi cetak B2B, penawaran solusi bernilai tambah, dan presentasi produk Konica Minolta ke 100+ korporat.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Memimpin strategi periklanan multi-channel, kampanye promosi terpadu, hubungan media/brand, dan produksi konten kreatif di 8 gerai ritel.",
      "highlights": [
  ...
  "finance_accounting": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Mengelola kontrol anggaran proyek, efisiensi biaya manufaktur-instalasi, dan rekonsiliasi pengeluaran operasional 100+ proyek interior.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Mengelola skema pembiayaan sewa/beli mesin B2B, analisis margin kontrak korporat, dan rekonsiliasi penagihan untuk 100+ akun industri.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Mengelola rekonsiliasi kas harian, pencatatan penerimaan omzet toko, dan kontrol biaya operasional 5 gerai ritel.",
      "highlights": [
        "Melakukan verifikasi dan rekonsiliasi harian laporan setor kas tunai serta transaksi EDC/QRIS dari 5 gerai ritel.",
        "Mengontrol pengeluaran kas kecil (petty cash) dan efisiensi pengeluaran biaya operasional bulanan toko.",
        "Penyusunan rekapitulasi laporan keuangan harian dan verifikasi saldo kasir cabang."
      ],
      "metrics": [
        {
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengelola alokasi anggaran promosi, evaluasi efektivitas biaya kampanye (ROI), rekonsiliasi klaim diskon principal, dan audit kasir di 8 gerai ritel.",
      "highlights": [
  ...
  "software_development": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Merancang, membangun, dan mengelola aplikasi web operasional (Logistor App) untuk otomatisasi pelaporan 6 divisi dan 100+ proyek interior.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Mengembangkan platform CRM web NextMark, otomasi alur kerja Google Sheets/Forms, dan integrasi pemetaan digital untuk 100+ klien B2B.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengelola sistem katalog web landing page, integrasi iklan digital, dan dukungan IT operasional untuk 5 gerai ritel.",
      "highlights": [
        "Mengembangkan dan memelihara halaman web katalog produk ritel serta penawaran promosi digital.",
        "Mengintegrasikan pelacakan konversi Meta Pixel dan TikTok Ads pada landing page promo toko.",
        "Memberikan dukungan teknis pemeliharaan sistem POS dan kelancaran jaringan sistem toko."
      ],
      "metrics": [
        {
          "label": "Sistem Ritel",
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengelola integrasi platform periklanan digital, manajemen aset multimedia berbasis cloud, dan pelaporan analitik POS di 8 gerai ritel.",
      "highlights": [
  ...
  "branch_manager": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Memimpin pengawasan operasional workshop manufaktur, tim instalasi lapangan, dan kepatuhan SLA pelayanan untuk 100+ proyek di wilayah Jabodetabek.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Mengelola operasional pelayanan akun korporat B2B, armada servis, dan pencapaian target cabang di wilayah Cikarang, Bekasi, dan Karawang.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Memimpin operasional harian cabang, pencapaian target penjualan, dan kepatuhan SOP pelayanan di 5 gerai ritel.",
      "highlights": [
        "Mengawasi kinerja operasional harian dan produktivitas tim staf toko di 5 cabang ritel.",
        "Mendorong ketercapaian target penjualan harian dan bulanan cabang melalui pelayanan prima dan promosi efektif.",
        "Mengelola penyelesaian masalah operasional toko, penanganan komplain pelanggan, dan rotasi stok."
      ],
      "metrics": [
        {
          "label": "Supervisi Cabang",
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengawasi operasional ritel, audit display toko, pencapaian target penjualan, dan kesiapan staf di 8 unit gerai cabang Purwakarta dan Bandung.",
      "highlights": [
  ...
  "office_administration": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Mengelola tata kelola administrasi proyek, pengarsipan dokumen kontrak, SOP operasional, dan korespondensi lintas 6 divisi untuk 100+ proyek interior.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Mengelola administrasi kontrak penjualan/sewa B2B, database korporat 4.000+ perusahaan, dan surat-menyurat pengadaan mesin Konica Minolta.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengelola administrasi program promosi, dokumentasi perjanjian kemitraan principal, dan pelaporan inventaris promosi di 8 gerai ritel.",
      "highlights": [
  ...
  "public_relations": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Mengelola komunikasi hubungan eksternal dengan klien korporat, manajemen komplain, dan representasi profesional untuk 100+ proyek interior.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Mengelola hubungan komunikasi korporat B2B, representasi publik perusahaan, dan negosiasi akun industri mesin cetak digital Konica Minolta.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengelola komunikasi publik, publikasi promosi media sosial, dan hubungan pelanggan untuk jaringan 5 gerai ritel.",
      "highlights": [
        "Merancang pengumuman promosi toko, publikasi media sosial, dan materi komunikasi merek ritel.",
        "Menangani hubungan komunikasi pelanggan dan reputasi brand toko secara responsif.",
        "Mengoordinasikan acara aktivasi toko lokal dan kemitraan promosi komunitas."
      ],
      "metrics": [
        {
          "label": "Media Ritel",
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Memimpin komunikasi publik, hubungan media & principal, kampanye branding, dan pengelolaan media sosial di 8 gerai ritel.",
      "highlights": [
  ...
  "sales_executive": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Mengelola kesiapan operasional dalam memenuhi komitmen kontrak penjualan proyek interior komersial bernilai tinggi untuk 100+ klien.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Memimpin penjualan langsung B2B, kanvasing kawasan industri, negosiasi kontrak korporat, dan pencapaian target penjualan Konica Minolta.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Mendorong pencapaian target omzet ritel, eksekusi strategi penawaran harian, dan supervisi staf penjualan di 5 gerai.",
      "highlights": [
        "Merancang teknik penawaran produk unggulan harian dan program bundling khusus di toko.",
        "Melatih staf penjaga toko dalam melakukan pencapaian target penjualan, up-selling, dan cross-selling.",
        "Memantau pencapaian omzet harian cabang dan tingkat konversi pengunjung toko."
      ],
      "metrics": [
        {
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Memimpin strategi peningkatan omzet penjualan ritel, program promo pendorong konversi kasir, dan kampanye iklan di 8 gerai cabang.",
      "highlights": [
  ...
  "supply_chain_logistics": [
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Mengelola pengadaan material interior, manajemen pergudangan workshop, jadwal armada logistik, dan instalasi on-site 100+ proyek.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "b2b",
      "description": "Mengelola distribusi unit mesin digital, rantai pasok suku cadang/consumable (toner), dan perutean armada servis di 4 kawasan industri.",
      "highlights": [
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "operations",
      "description": "Mengelola alur pasokan barang, stock opname ritel, dan efisiensi pengiriman distribusi ke 5 gerai toko.",
      "highlights": [
        "Mengoordinasikan alur pengisian ulang (replenishment) stok barang dari gudang ke 5 gerai toko tepat waktu.",
        "Melaksanakan stok opname berkala untuk memastkan akurasi jumlah fisik barang dengan sistem POS.",
        "Meminimalkan risiko kekosongan stok (stock-out) untuk produk-produk terlaris di seluruh cabang."
      ],
      "metrics": [
        {
    ...
    },
    {
      ...
      "type": "Full-time",
      "category": "marketing",
      "description": "Mengelola distribusi materi promosi, perputaran stok inventori display gerai, dan koordinasi pasokan dari 10+ brand principal di 8 gerai ritel.",
      "highlights": [
